package Presentacion.Recepcionista;
...
public class VRecepcionista extends JFrame implements IGUI {
	...
	public VRecepcionista() { 
		super("Vista Recepcionista");
	...
	public void initGUI() {
		...
		crearButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.ABRIR_VALTA_RECEPCIONISTA, null);
				setVisible(false);
			}
		});
		...
		eliminarButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.ABRIR_VBAJA_RECEPCIONISTA, null);
				setVisible(false);
			}
		});
		...
		editarButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.ABRIR_VMODIFICAR_RECEPCIONISTA, null);
				setVisible(false);
			}
		});
		...
		mostrarPorIdButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.ABRIR_VMOSTRAR_POR_ID_RECEPCIONISTA, null);
				setVisible(false);
			}
		});
		botonesPanel.add(mostrarPorIdButton);
		
		// MOSTERAR_POR_NOMBRE BUTTON
		mostrarPorNombreButton = new JButton("MOSTRAR POR NOMBRE");
		mostrarPorNombreButton.setPreferredSize(new Dimension(200, 50));
		mostrarPorNombreButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.ABRIR_VMOSTRAR_POR_NOMBRE_RECEPCIONISTA, null);
				setVisible(false);
			}
		});
		...
		mostrarTodosButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.MOSTRAR_TODOS_RECEPCIONISTA, null);
				setVisible(false);
			}
		});
