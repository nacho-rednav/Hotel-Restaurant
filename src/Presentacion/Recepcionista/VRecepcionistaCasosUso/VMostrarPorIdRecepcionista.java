...
public class VMostrarPorIdRecepcionista extends JFrame implements IGUI {
	private Controller ctrl;
	private int _id;
	
	public VMostrarPorIdRecepcionista() {
	...
	public void initIGUI() {
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.MOSTRAR_RECEPCIONISTA_ID, _id);
				setVisible(false);
			}
		});
