...
public class VMostrarPorNumeroHabitacion extends JFrame implements IGUI {

	public Controller ctrl;
	private int _id;

	public VMostrarPorNumeroHabitacion() {
		super("Mostrar habitacion");
	...
	public void initIGUI() {
		...
		//ID
		idInfoPanel.add(new JLabel("Numero habitacion: "));
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.MOSTRAR_HABITACION_NUMERO, _id);
				setVisible(false);
			}
		});
