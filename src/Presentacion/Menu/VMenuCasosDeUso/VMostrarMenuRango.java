...
public class VMostrarMenuRango extends JFrame implements IGUI{
	private Controller ctrl;
	private TQuery rango;
	private JTextField min, max;
	
	public VMostrarMenuRango() {
		super("Mostrar Menus en rango de precio");
...
//		});
	...
	public void initGUI(){
		...
		takingInfoPanel.add(new JLabel("Precio minimo: "));
		min = textField();
		takingInfoPanel.add(min);
		takingInfoPanel.add(new JLabel("Precio maximo: "));
		max = textField();
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					setVisible(false);
					ctrl.accion(Events.MOSTRAR_MENU_RANGO, rango);
