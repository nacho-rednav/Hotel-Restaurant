...
public class VAniadirProducto extends JFrame implements IGUI {
	private int _idProd;
	private int _idMenu;
	private Controller ctrl;
	
	public VAniadirProducto() {
		super("Aniadir Producto a Menu");
	...
	JButton okButton(){
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ctrl.accion(Events.VINCULAR_PRODUCTO, new TMenuProducto(_idMenu, _idProd));
			}
		});
