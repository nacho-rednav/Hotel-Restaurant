...
public class VMostrarReservasPorServicio extends JFrame implements IGUI {
	private Controller ctrl;
	private int _id;
	
	public VMostrarReservasPorServicio() {
	...
	private void initGUI() {
		...
		idInfo.add(new JLabel("ID del servicio: "));
	...
	JButton okButton() {
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.MOSTRAR_SERVICIO_RESERVAS, _id);
				setVisible(false);
			}
		});
