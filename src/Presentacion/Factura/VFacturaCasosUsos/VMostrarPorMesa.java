...
public class VMostrarPorMesa extends JFrame implements IGUI {
	public Controller ctrl;
	private int _id;
	private JButton cancelButton;
	
	
	public VMostrarPorMesa() {
		super("Mostrar facturas por mesa");
	...
	public void initIGUI(){
		...
		// ID
		idInfoPanel.add(new JLabel("ID mesa: "));
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.MOSTRAR_FACTURA_POR_MESA, _id);
				setVisible(false);
			}
		});
