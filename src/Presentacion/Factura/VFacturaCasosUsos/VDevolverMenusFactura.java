...
public class VDevolverMenusFactura extends JFrame implements IGUI {
	...
	public VDevolverMenusFactura() {
		super("Devolver menus factura");
	...
	public void initIGUI(){
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.DEVOLVER_MENU, new TLineaDePedido(id_menu, cantidad, id_factura, null));
				setVisible(false);
			}
		});
