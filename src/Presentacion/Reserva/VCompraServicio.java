...
public class VCompraServicio extends JFrame implements IGUI {
	public Controller ctrl;
	private int _id;

	public VCompraServicio() {
		super("Compra de servicio");
	...
	public void initIGUI() {
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				ctrl.accion(Events.COMPRA_SERVICIO_RESERVA, _id);
				setVisible(false);
			}
		});
