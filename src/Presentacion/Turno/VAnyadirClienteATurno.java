...
import static Negocio.Cliente.TCliente.*;
...
public class VAnyadirClienteATurno extends JFrame implements IGUI {
	private int _idCliente;
	private int _idTurno;
	private Controller controller;
	
	public VAnyadirClienteATurno() {
		super("Anyadir Cliente a Turno");
	...
	JButton okButton(){
		...
		okB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				controller.accion(Events.VINCULAR_TURNO_CLIENTE, new TTurnoCliente(_idTurno, _idCliente));
			}
		});
