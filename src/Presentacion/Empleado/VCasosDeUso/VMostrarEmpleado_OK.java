...
public class VMostrarEmpleado_OK extends JFrame implements IGUI{
	private Controller ctrl;
	private TablaEmpleados empleadosTable;
	private JButton cancelButton;
	
	public VMostrarEmpleado_OK(){
...
//		Controller.obtenerInstancia().accion(Events.MOSTRAR_EMPLEADO_TODOS, null);
	...
	public void update(Object data) {
		Collection<TEmpleado> empleado = new ArrayList<TEmpleado>();
		empleado.add((TEmpleado)data);
			empleadosTable.setData(empleado);
	}
}